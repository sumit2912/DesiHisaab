package com.dalakiya.infotech.desihisaab.pref
...
class PrefManager(appManager: AppManager, sharedPreferences: SharedPreferences, editor: SharedPreferences.Editor) {
    ...
    fun setSrNoVisibility(key: String, value: Int) {
        editor.putInt(key, value)
        editor.commit()
    }
    ...
    fun getSrNoVisibility(key: String): Int {
        return sharedPreferences.getInt(key, View.GONE)
    }
